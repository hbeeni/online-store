...
alter table cart_product add constraint FK_cart_product_cart
    foreign key (cart_id) references cart (id);

alter table cart_product add constraint FK_cart_product_product
    foreign key (product_id) references product (id);

alter table order_product add constraint FK_order_product_orders
