    ...
    void test_order() throws Exception {
        ...
        mvc.perform(
                ...
                .andDo(document(
                        ...
                        preprocessResponse(prettyPrint()),
                        requestFields(
                                subsectionWithPath("productIdToQuantity").type(JsonFieldType.OBJECT).description("상품 시퀀스 : 수량 맵"),
                                fieldWithPath("deliveryAddress").type(JsonFieldType.STRING).description(DELIVERY_REQUEST_ADDRESS.getDescription()),
                                fieldWithPath("receiverName").type(JsonFieldType.STRING).description(DELIVERY_REQUEST_RECEIVER_NAME.getDescription()),
                                fieldWithPath("receiverPhone").type(JsonFieldType.STRING).description(DELIVERY_REQUEST_RECEIVER_PHONE.getDescription())
                        ),
                        responseFields(
                                RestDocsUtils.STATUS,
                                fieldWithPath("data.id").type(JsonFieldType.NUMBER).description(ADD.getDescription() + ORDER_ID.getDescription())
                        )
                ));
    ...
    void test_cancelOrder() throws Exception {
        ...
        mvc.perform(put("/api/orders/{orderId}/cancel", orderId))
                ...
                .andDo(document(
                        ...
                        responseFields(
                                RestDocsUtils.STATUS,
                                fieldWithPath("data.id").type(JsonFieldType.NUMBER).description("취소된 " + ORDER_ID.getDescription())
                        )
                ));
