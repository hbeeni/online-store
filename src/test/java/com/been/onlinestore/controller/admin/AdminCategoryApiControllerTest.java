...
import static com.been.onlinestore.controller.restdocs.FieldDescription.CATEGORY_DESCRIPTION;
...
import static com.been.onlinestore.controller.restdocs.FieldDescription.CATEGORY_PRODUCT_COUNT;
    ...
    void test_getCategories() throws Exception {
        ...
        mvc.perform(get("/api/admin/categories"))
                ...
                .andDo(document(
                        ...
                        responseFields(
                                STATUS,
                                fieldWithPath("data[].id").type(JsonFieldType.NUMBER).description(CATEGORY_ID.getDescription()),
                                fieldWithPath("data[].name").type(JsonFieldType.STRING).description(CATEGORY_NAME.getDescription()),
                                fieldWithPath("data[].description").type(JsonFieldType.STRING).description(CATEGORY_DESCRIPTION.getDescription()),
                                fieldWithPath("data[].productCount").type(JsonFieldType.NUMBER).description(CATEGORY_PRODUCT_COUNT.getDescription()),
    ...
    void test_addCategory() throws Exception {
        ...
        mvc.perform(
                ...
                .andDo(document(
                        ...
                        preprocessResponse(prettyPrint()),
                        requestFields(
                                fieldWithPath("name").type(JsonFieldType.STRING).description(CATEGORY_NAME.getDescription()),
                                fieldWithPath("description").type(JsonFieldType.VARIES).description(CATEGORY_DESCRIPTION.getDescription())
                        ),
                        responseFields(
                                STATUS,
                                fieldWithPath("data.id").type(JsonFieldType.NUMBER).description(ADD.getDescription() + CATEGORY_ID.getDescription())
                        )
                ));
    ...
    void test_updateCategory() throws Exception {
        ...
        mvc.perform(
                ...
                .andDo(document(
                        ...
                        responseFields(
                                STATUS,
                                fieldWithPath("data.id").type(JsonFieldType.NUMBER).description(UPDATE.getDescription() + CATEGORY_ID.getDescription())
                        )
                ));
        ...
        mvc.perform(delete("/api/admin/categories/{categoryId}", id))
                ...
                .andDo(document(
                        ...
                        responseFields(
                                ...
                                fieldWithPath("data.id").type(JsonFieldType.NUMBER).description(DELETE.getDescription() + CATEGORY_ID.getDescription())
                        )
                ));
