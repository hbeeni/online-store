...
values (now(), now(), 'admin', 'admin', 3000, '깐대파 500g', 'c1b2f2a2-f0b8-403a-b03b-351d1ee0bd05.jpg',
       ...
       (now(), now(), 'admin', 'admin', 3000, '제주 광어회 120g (냉장)', '4f1adad1-f619-4d06-9fb6-1672334e9594.jpg',
        '희고 깨끗한 감칠맛 한 점', 11900, 'SALE', 87, 56, 3),          -- 5
       (now(), now(), 'admin', 'admin', 3000, '양념 소불고기 1kg (냉장)', 'd6e89ff1-8e66-4344-966f-6b8c31f53ba2.jpg',
        '100g당 : 1,869원', 18690, 'SALE', 120, 20, 4),         -- 6
       ...
       (now(), now(), 'admin', 'admin', 3000, '신라면 멀티 5입', '4432a267-6387-401c-8004-ecfc545068e4.jpg',
        '얼큰한 라면의 대명사', 3900, 'OUT_OF_STOCK', 1540, 0, 7),     -- 9
