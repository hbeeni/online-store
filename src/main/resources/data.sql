...
values (now(), now(), 'seller', 'seller', 3000, '꽃무늬 바지', null, '꽃무늬 바지', 12000, 'SALE', 10, 100, 1, 1),
       (now(), now(), 'seller', 'seller', 3000, '꽃무늬 셔츠', null, '꽃무늬 셔츠', 15500, 'SALE', 20, 121, 1, 2),
       (now(), now(), 'seller', 'seller', 0, '프렌치 코트', null, '프렌치 코트', 53000, 'WAIT', 0, 55, 1, 1),
       (now(), now(), 'seller', 'seller', 3000, '아보카도', null, '아보카도', 2300, 'SALE', 120, 20, 3, 3),
       (now(), now(), 'seller', 'seller', 3000, '요거트', null, '요거트', 3500, 'SALE', 22, 56, 3, 1);
