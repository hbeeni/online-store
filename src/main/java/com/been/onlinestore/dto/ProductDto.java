...
public record ProductDto(
        Long id,
        CategoryServiceRequest categoryServiceRequest,
        UserDto sellerDto,
        String name,
        Integer price,
        String description,
    ...
    public static ProductDto of(Long id, CategoryServiceRequest categoryServiceRequest, UserDto sellerDto, String name, Integer price, String description, Integer stockQuantity, Integer salesVolume, SaleStatus saleStatus, Integer deliveryFee, String imageUrl, LocalDateTime createdAt, String createdBy, LocalDateTime modifiedAt, String modifiedBy) {
        return new ProductDto(id, categoryServiceRequest, sellerDto, name, price, description, stockQuantity, salesVolume, saleStatus, deliveryFee, imageUrl, createdAt, createdBy, modifiedAt, modifiedBy);
    }
