...
public record OrderProductResponse(
	...
	public static OrderProductResponse of(Long id, String productName, int price, int quantity, int totalPrice,
			DeliveryStatus deliveryStatus, int deliveryFee, LocalDateTime deliveredAt) {
		return new OrderProductResponse(id, productName, price, quantity, totalPrice, deliveryStatus, deliveryFee,
				deliveredAt);
	}
